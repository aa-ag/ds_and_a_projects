'''
We have briefly discussed caching as part of a practice problem while studying 
hash maps.
...
must insert the element. 
If the cache is full, you must write code that removes the least 
...
# returns -1 because the cache reached it's capacity and
